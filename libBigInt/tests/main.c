...
MU_TEST(sum_tests)
{
    ...
    char *res_str = to_str(res);

    mu_assert_int_eq(5, res->n);
    mu_assert_string_eq(ans1, res_str);
    ...
    mu_assert_int_eq(5, res->n);
    mu_assert_string_eq(ans2, res_str);
    ...
    mu_assert_int_eq(5, res->n);
    mu_assert_string_eq(ans3, res_str);
    ...
    mu_assert_int_eq(5, res->n);
    mu_assert_string_eq(ans4, res_str);
...
MU_TEST(sub_tests)
{
    ...
    char *res_str = to_str(res);
    mu_assert_string_eq("1234", res_str);
    ...
    res = subtraction(a, b);
    res_str = to_str(res);
    mu_assert_string_eq("8889", res_str);
    ...
    res = subtraction(a, b);
    res_str = to_str(res);
    mu_assert_string_eq("-15801", res_str);
...
MU_TEST(mult_tests)
{
    ...
    char *res_str = to_str(res);
    mu_assert_string_eq("1518435", res_str);
    ...
    res = multiplication(a, b);
    res_str = to_str(res);
    mu_assert_string_eq("998001", res_str);
...
MU_TEST(division_tests)
{
    ...
    res = division(a, b);
    res_str = to_str(res);
    mu_assert_string_eq("100371", res_str);
...
MU_TEST(factorial_tests)
{
    ...
    char *str_res = to_str(myfact);
    mu_assert_string_eq(res, str_res);
    BigInt_free(myfact);
    free(str_res);
}
int main()
